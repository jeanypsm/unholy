      ...
      <div className="relative z-10 mx-auto max-w-2xl text-center">
        ...
        <div className="mt-6 flex flex-col items-center gap-3">
          <p className="font-mono text-xs text-ash/70">
            Site codado by <span className="text-primary">xulinn</span> - <span className="text-primary">xulinndex</span>
          </p>
          
          {/* Contact buttons */}
          <div className="flex flex-wrap items-center justify-center gap-2">
            <a
              href="https://discord.com/users/xulinnn"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 rounded border border-primary/30 bg-primary/5 px-3 py-1.5 font-mono text-xs text-ash transition-all hover:border-primary hover:bg-primary/10 hover:text-primary"
            >
            ...
            <a
              href="https://wa.me/5547996907477"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 rounded border border-primary/30 bg-primary/5 px-3 py-1.5 font-mono text-xs text-ash transition-all hover:border-primary hover:bg-primary/10 hover:text-primary"
            >
